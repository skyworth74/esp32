...
#define LEDC_DUTY_RES           LEDC_TIMER_8_BIT//LEDC_TIMER_13_BIT // Set duty resolution to 13 bits
#define LEDC_DUTY               128//(4095) // Set duty to 50%. ((2 ** 13) - 1) * 50% = 4095
#define LEDC_FREQUENCY          600//(5000) // Frequency in Hertz. Set frequency at 5 kHz
